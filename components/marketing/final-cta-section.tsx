...
export function FinalCtaSection() {
  return (
    <section
      id="final-cta"
      className="bg-[linear-gradient(180deg,#F7F6F1_0%,#E7EFE4_100%)]"
    >
      <div className="mx-auto max-w-7xl px-5 py-20 sm:px-8 sm:py-24 lg:px-10 lg:py-32">
        <Reveal>
          <div className="relative overflow-hidden rounded-[2rem] border border-slate-900/10 bg-[linear-gradient(180deg,rgba(255,255,255,0.94)_0%,rgba(245,248,243,0.98)_100%)] px-5 py-9 shadow-[0_24px_80px_rgba(15,23,42,0.07)] sm:px-8 sm:py-12 lg:px-12 lg:py-14">
            ...
            <div className="relative grid gap-8 lg:grid-cols-[0.9fr_1fr] lg:items-center lg:gap-12">
              ...
              <div className="min-w-0 rounded-[1.75rem] border border-slate-900/10 bg-white/65 p-3 shadow-[0_18px_50px_rgba(15,23,42,0.05)] backdrop-blur-sm sm:p-5">
                <AuditInputPill
                  id="final-website-url"
                  className="mt-0 max-w-none sm:mt-0"
                  controlClassName="flex-col items-stretch rounded-[1.35rem] p-2 pl-4 sm:flex-row sm:items-center sm:rounded-full sm:pl-5"
